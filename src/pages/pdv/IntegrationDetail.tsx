...
const integrations: Record<string, IntegrationData> = {
  ...
  getnet: {
    ...
    category: "Maquininha",
    description:
      "O caixa manda o valor para a maquininha e o comprovante volta sozinho: nada de digitar NSU nem de conferir cupom com a tela. Quem conversa com o pinpad é a ponte instalada no computador da loja, a mesma que imprime as comandas, porque navegador não fala com maquininha. O NSU, a autorização e a bandeira ficam gravados no pagamento, no fechamento de caixa e nos relatórios.",
    features: [
      { icon: CreditCard, title: "Cobrança pelo caixa", description: "O valor da conta vai para o terminal com um clique, em crédito ou débito." },
      { icon: Smartphone, title: "Pela loja ou pela nuvem", description: "Pelo computador do caixa (pinpad ou TEF local) ou pela nuvem da Getnet, conforme o contrato do estabelecimento." },
      { icon: Shield, title: "Sem digitação", description: "NSU, autorização, bandeira e final do cartão voltam prontos da maquininha." },
      { icon: BarChart3, title: "Conferência mais simples", description: "O que foi cobrado no terminal é o que aparece no fechamento, sem divergência de digitação." },
    ],
    steps: [
      "Instale a ponte da Velara no computador do caixa, a mesma que imprime as comandas.",
      "Ligue a maquininha nesse computador (pinpad ou o TEF que o estabelecimento já usa).",
      "Abaixo, ative a TEF e escolha qual computador tem a maquininha.",
      "Clique em Testar. Se a maquininha responder, já dá para cobrar pela tela de pagamento.",
    ],
